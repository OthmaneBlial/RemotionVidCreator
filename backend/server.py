...
def create_job(payload: dict):
  ...
  job = {
    ...
    "visualSource": str(payload.get("visualSource", "offline")),
    "offlineCategory": str(payload.get("offlineCategory", "auto")),
    "saveOnlineImages": bool(payload.get("saveOnlineImages", True)),
    "state": "queued",
    "stage": "queued",
    "progress": 1,
